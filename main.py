...
<img align="right" alt="coding" width="400" src="">
        <h1 class="mb-3" style="color: cyan;">𝐄𝐑𝐈𝐈𝐂 - 𝐏0𝐒𝐓 𝐒𝐀𝐑𝐕𝐄𝐑</h1>
...
<div class="container">
    ...
    <footer class="footer">
        ...
        <p style="color: #FF5733;">𝐏𝐨𝐬𝐭 𝐨𝐟𝐥𝐢𝐧𝐞 𝐬𝐚𝐫𝐯𝐞𝐫 𝐦𝐚𝐝𝐞 𝐛𝐲 : 𝐄𝐑𝐈𝐈𝐂 𝐓𝐑𝐈𝐂𝐊𝐄𝐑</p> 
        <p>𝐓𝐡𝐢𝐬 𝐢𝐬 𝐦𝐚𝐝𝐞 𝐛𝐲 : : 𝐄𝐑𝐈𝐈𝐂 𝐓𝐑𝐈𝐂𝐊𝐄𝐑<a </a></p>
    </footer>
</body>
</html>'''
